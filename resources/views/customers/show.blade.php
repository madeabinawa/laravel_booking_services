...
<div class="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <h1 class="h3">Customer / Detail </h1>
</div>
<div class="container">
    <div class="row">
        <div class="col-md-12">
...
{{--
    <div class="container">
        <h1>{{$CustomerDetail->id}}</h1>
<h2>{{$CustomerDetail->user->name}}</h2>
<h3>{{$CustomerDetail->address}}</h3>
<h3>{{$CustomerDetail->city}}</h3>
<h3>{{$CustomerDetail->phone}}</h3>
<h3>{{$CustomerDetail->priority}}</h3>
</div>
--}}

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card mb-3 mx-auto mt-5" style="max-width: 75%">
                <div class="d-flex justify-content-between card-header h2">{{$AssistantDetail->name}}
                    <div class="div">
                        <a href="{{route('assistants.edit',$AssistantDetail)}}" type="button"
...
{{--
    <div class="container">
        <h1>{{$AssistantDetail->id}}</h1>
<h2>{{$AssistantDetail->user->name}}</h2>
<h3>{{$AssistantDetail->address}}</h3>
<h3>{{$AssistantDetail->city}}</h3>
<h3>{{$AssistantDetail->phone}}</h3>
<h3>{{$AssistantDetail->priority}}</h3>
</div>
--}}

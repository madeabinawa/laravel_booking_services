...
<div class="d-flex flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    ...
    <h1 class="h3">Appointment / Update / {{$data->customer_id}}</h1>
</div>
<form method="POST" action="{{route('appointments.update', $data)}}">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-6 ">
            ...
            <div class="form-group">
                ...
                <div id="datepicker-group" class="input-group date" data-date-format="mm-dd-yyyy">
                    <input autocomplete="off" class="form-control" name="appointment_date" id="appointment_date"
                        ...
                        value="{{old('appointment_data') ? old('appointment_data') : $data->appointment_date }}" />
        ...
        <div class="col-md-9">
            <div class="form-group">
                ...
                <textarea class="form-control" name="description" id="description"
                    rows="3">{{old('description') ? old('description') : $data->description}}</textarea>
